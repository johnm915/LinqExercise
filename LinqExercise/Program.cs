...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Avgerage: {avg}");
            ...
            Console.WriteLine("Greater then 6:");
            ...
            Console.WriteLine("Take 1st four acsending");
            ...
            employees = employees.Append(new Employee("first", "Last", 50, 10)).ToList();
